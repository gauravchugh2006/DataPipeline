...
\begin{figure}[H]
    \centering
    \IfFileExists{figures/data_engineering_manifesto.png}{\includegraphics[width=0.9\textwidth]{figures/data_engineering_manifesto.png}}{\fbox{\parbox{0.9\textwidth}{\centering Poster illustration placeholder\\Download and save as \texttt{report/figures/data\_engineering\_manifesto.png}}}}
